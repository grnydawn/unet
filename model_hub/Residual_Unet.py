    ...
    def __init__(self, 
        ...
        for i in range(num_blocks):
            ...
            self.encoder_blocks.append(
                ResidualUNetBlock(current_channels, out_channels_block, is_encoder=True)
            )
        ...
        for i in range(num_blocks-1, 0, -1):
            ...
            self.decoder_blocks.append(
                ResidualUNetBlock(in_channels_block, out_channels_block, is_encoder=False)
            )
...
if __name__ == "__main__":
    ...
    model = ResidualUNet(in_channels=input_channels, out_channels=1, num_blocks=num_blocks, base_channels=base_filters)
    # print("\nModel structure:")
    # print(model)
