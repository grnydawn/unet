...
#export MIOPEN_USER_DB_PATH=/lustre/orion/cli115/scratch/grnydawn/tmpdir
#if [ "$SLURM_LOCALID" -eq 0 ]; then
#    echo "This is the local rank 0 process."
...
NUM_TRIES=12
NUM_BATCH=4
WORKDIR=unet_orgcache.batch${NUM_BATCH}.${NUM_NODES}.${NUM_TRIES}
